...
Contributors: SiteOrigin,livemesh
...
Micemade SO widgets widgets features huge collection of premium, easy to use yet highly functional widgets that can be used in a page builder like <a href="https://wordpress.org/plugins/siteorigin-panels/" rel="nofollow">SiteOrigin</a> or in any widgetized area of your site. This is really a premium plugin that you can get for free.
...
<li><a href="http://portfoliotheme.org/siteorigin-widgets/livemesh-grid/" title="Micemade Grid">Lazy Load</a> - The portfolio/post grid and image gallery widgets incorporate option to lazy load posts/images with the click of a Load More button.</li>
<li><a href="http://portfoliotheme.org/siteorigin-widgets/livemesh-grid/" title="Micemade Grid">Pagination</a> - Create a grid of posts or custom post types with AJAX based pagination support. </li>
