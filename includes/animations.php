...
defined( 'ABSPATH' ) or die( __( 'Cheatin\' huh ?.', 'mm_sow' ) );

add_action( 'wp_enqueue_scripts', 'mm_sow_libraries' );

add_action( 'wp_footer', 'mm_sow_init_wow' );

add_filter( 'siteorigin_panels_widget_style_groups', 'mm_sow_style_groups', 2, 3 );
add_filter( 'siteorigin_panels_widget_style_fields', 'mm_sow_style_fields', 1, 3 );
add_filter( 'siteorigin_panels_widget_style_attributes', 'mm_sow_style_attributes', 1, 2 );
 ...
 */
function mm_sow_style_groups( $groups ) 
{
    
    $groups['animation'] = array(
    	'name' => __('Animation', 'mm_sow'),
   	 	'priority' => 30
    );
 ...
 */
function mm_sow_style_fields( $fields ) 
{
    /**/
    $animations = array(
    '' => 'No Animations',
 ...
 */
function mm_sow_style_attributes( $atts, $value ) 
{
 ...
 * @return void
 */
function mm_sow_libraries() 
{
	//wp_enqueue_style( 'mm_sow-animate', MM_SOW_PLUGIN_URL .'assets/css/animate.min.css', 1.0, true );

	wp_enqueue_script( 'mm_sow-wow',  MM_SOW_PLUGIN_URL .'assets/js/wow.min.js', array('jquery'), 1.0, true );

	return;
}

function mm_sow_init_wow() {
	?>
	<script>
